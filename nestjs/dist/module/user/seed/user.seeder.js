        ...
        for (const user of users) {
            try {
                if (user.email) {
                    ...
                    if (existingUser) {
                        console.log(...oo_oo(`74791776_222_12_222_72_4`, `User with email ${user.email} already exists.`));
                        continue;
                    }
                }
                await this.userService.create(user);
                console.log(...oo_oo(`74791776_229_8_229_67_4`, `User ${user.firstName} created successfully.`));
            }
            catch (error) {
                console.error(...oo_tx(`74791776_231_8_233_9_11`, `Failed to create user ${user.firstName}: ${error.message}`));
            }
        }
    }
};
